package com.timappweb.timapp.views.slidingTab;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabViewLayoutId = typedArray.getResourceId(R.styleable.SlidingTabLayout_tabBackgroundBase, mTabViewLayoutId);
