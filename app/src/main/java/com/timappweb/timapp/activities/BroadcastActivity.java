...
public class BroadcastActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Spot.isBroadcasting()){
            startActivity(new Intent(this, CurrentSpotActivity.class));
            return;
        }
        ...
        Button b = (Button) findViewById(R.id.button_broadcast);
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog.show();
                BroadcastActivity activity = (BroadcastActivity) v.getContext();
                activity.broadcastPosition();
            }
        });
    }
        ...
        RestClient.instance().getService().addSpot(spot, new RestCallback<RestFeedback>() {
            ...
            public void success(RestFeedback restFeedback, Response response) {
                ...
                if (restFeedback.success){
                    ...
                    Intent intent = new Intent(getApplicationContext(), CurrentSpotActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Log.d(TAG, "User clicked on menu item: " + id);
