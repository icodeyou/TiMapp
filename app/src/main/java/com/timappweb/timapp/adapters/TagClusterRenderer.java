...
public class TagClusterRenderer implements ClusterRenderer<MapTag> {
    ...
    public void onAdd() {
        this.mClusterManager.getMarkerCollection().setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker) {
                return TagClusterRenderer.this.mItemClickListener != null
                        && TagClusterRenderer.this.mItemClickListener.onClusterItemClick(TagClusterRenderer.this.mMarkerCache.get(marker));
            }
        });
        this.mClusterManager.getMarkerCollection().setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            public void onInfoWindowClick(Marker marker) {
                if(TagClusterRenderer.this.mItemInfoWindowClickListener != null) {
                    TagClusterRenderer.this.mItemInfoWindowClickListener.onClusterItemInfoWindowClick(TagClusterRenderer.this.mMarkerCache.get(marker));
                }
        ...
        this.mClusterManager.getClusterMarkerCollection().setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker) {
                return TagClusterRenderer.this.mClickListener != null && TagClusterRenderer.this.mClickListener.onClusterClick(TagClusterRenderer.this.mMarkerToCluster.get(marker));
            }
        });
        this.mClusterManager.getClusterMarkerCollection().setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            public void onInfoWindowClick(Marker marker) {
                if (TagClusterRenderer.this.mInfoWindowClickListener != null) {
                    TagClusterRenderer.this.mInfoWindowClickListener.onClusterInfoWindowClick((Cluster) TagClusterRenderer.this.mMarkerToCluster.get(marker));
                }
    ...
    private class AnimationTask extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        private final TagClusterRenderer.MarkerWithPosition markerWithPosition;
        ...
        private AnimationTask(TagClusterRenderer.MarkerWithPosition markerWithPosition, LatLng from, LatLng to) {
        ...
        public void perform() {
            ...
            valueAnimator.setInterpolator(TagClusterRenderer.ANIMATION_INTERP);
        ...
        public void onAnimationEnd(Animator animation) {
            if(this.mRemoveOnComplete) {
                Cluster cluster = (Cluster)TagClusterRenderer.this.mMarkerToCluster.get(this.marker);
                TagClusterRenderer.this.mClusterToMarker.remove(cluster);
                TagClusterRenderer.this.mMarkerCache.remove(this.marker);
                TagClusterRenderer.this.mMarkerToCluster.remove(this.marker);
    ...
    private static class MarkerWithPosition {
        ...
        public boolean equals(Object other) {
            return other instanceof TagClusterRenderer.MarkerWithPosition?this.marker.equals(((TagClusterRenderer.MarkerWithPosition)other).marker):false;
        }
    ...
    private class CreateMarkerTask {
        ...
        private void perform(TagClusterRenderer.MarkerModifier markerModifier) {
            if(!TagClusterRenderer.this.shouldRenderAsCluster(this.cluster)) {
                ...
                while(markerOptions2.hasNext()) {
                    ...
                    if(markerWithPosition2 == null) {
                        ...
                        TagClusterRenderer.this.onBeforeClusterItemRendered(marker1, markerOptions1);
                        markerWithPosition2 = TagClusterRenderer.this.mClusterManager.getMarkerCollection().addMarker(markerOptions1);
                        markerWithPosition1 = new TagClusterRenderer.MarkerWithPosition(markerWithPosition2);
                        TagClusterRenderer.this.mMarkerCache.put(marker1, markerWithPosition2);
                        if(this.animateFrom != null) {
                    ...
                    TagClusterRenderer.this.onClusterItemRendered(marker1, markerWithPosition2);
                ...
                TagClusterRenderer.this.onBeforeClusterRendered(this.cluster, markerOptions);
                Marker marker = TagClusterRenderer.this.mClusterManager.getClusterMarkerCollection().addMarker(markerOptions);
                TagClusterRenderer.this.mMarkerToCluster.put(marker, this.cluster);
                TagClusterRenderer.this.mClusterToMarker.put(this.cluster, marker);
                TagClusterRenderer.MarkerWithPosition markerWithPosition = new TagClusterRenderer.MarkerWithPosition(marker);
                if(this.animateFrom != null) {
                    markerModifier.animate(markerWithPosition, this.animateFrom, this.cluster.getPosition());
                }

                TagClusterRenderer.this.onClusterRendered(this.cluster, marker);
    ...
    private class MarkerModifier extends Handler implements MessageQueue.IdleHandler {
        ...
        private Queue<TagClusterRenderer.CreateMarkerTask> mOnScreenCreateMarkerTasks;
        private Queue<Marker> mRemoveMarkerTasks;
        private Queue<Marker> mOnScreenRemoveMarkerTasks;
        private Queue<TagClusterRenderer.AnimationTask> mAnimationTasks;
        ...
        public void add(boolean priority, TagClusterRenderer.CreateMarkerTask c) {
            this.lock.lock();
        ...
        public void animate(TagClusterRenderer.MarkerWithPosition marker, LatLng from, LatLng to) {
            this.lock.lock();
            this.mAnimationTasks.add(TagClusterRenderer.this.new AnimationTask(marker, from, to));
            this.lock.unlock();
        }

        public void animateThenRemove(TagClusterRenderer.MarkerWithPosition marker, LatLng from, LatLng to) {
            this.lock.lock();
            TagClusterRenderer.AnimationTask animationTask = TagClusterRenderer.this.new AnimationTask(marker, from, to);
            animationTask.removeOnAnimationComplete(TagClusterRenderer.this.mClusterManager.getMarkerManager());
        ...
        private void performNextTask() {
            if(!this.mOnScreenRemoveMarkerTasks.isEmpty()) {
                ...
                ((TagClusterRenderer.AnimationTask)this.mAnimationTasks.poll()).perform();
            } else if(!this.mOnScreenCreateMarkerTasks.isEmpty()) {
                ((TagClusterRenderer.CreateMarkerTask)this.mOnScreenCreateMarkerTasks.poll()).perform(this);
            } else if(!this.mCreateMarkerTasks.isEmpty()) {
                ((TagClusterRenderer.CreateMarkerTask)this.mCreateMarkerTasks.poll()).perform(this);
        ...
        private void removeMarker(Marker m) {
            Cluster cluster = (Cluster)TagClusterRenderer.this.mMarkerToCluster.get(m);
            TagClusterRenderer.this.mClusterToMarker.remove(cluster);
            TagClusterRenderer.this.mMarkerCache.remove(m);
            TagClusterRenderer.this.mMarkerToCluster.remove(m);
            TagClusterRenderer.this.mClusterManager.getMarkerManager().remove(m);
        }
    ...
    private class RenderTask implements Runnable {
        ...
        public void setMapZoom(float zoom) {
            this.mMapZoom = zoom;
            this.mSphericalMercatorProjection = new SphericalMercatorProjection(256.0D * Math.pow(2.0D, (double)Math.min(zoom, TagClusterRenderer.this.mZoom)));
        }

        @SuppressLint({"NewApi"})
        public void run() {
            if(this.clusters.equals(TagClusterRenderer.this.mClusters)) {
                this.mCallback.run();
            } else {
                TagClusterRenderer.MarkerModifier markerModifier = TagClusterRenderer.this.new MarkerModifier();
                float zoom = this.mMapZoom;
                boolean zoomingIn = zoom > TagClusterRenderer.this.mZoom;
                float zoomDelta = zoom - TagClusterRenderer.this.mZoom;
                Set markersToRemove = TagClusterRenderer.this.mMarkers;
                LatLngBounds visibleBounds = this.mProjection.getVisibleRegion().latLngBounds;
                ArrayList existingClustersOnScreen = null;
                if(TagClusterRenderer.this.mClusters != null && TagClusterRenderer.SHOULD_ANIMATE) {
                    existingClustersOnScreen = new ArrayList();
                    Iterator newMarkers = TagClusterRenderer.this.mClusters.iterator();

                    while(newMarkers.hasNext()) {
                        Cluster newClustersOnScreen = (Cluster)newMarkers.next();
                        if(TagClusterRenderer.this.shouldRenderAsCluster(newClustersOnScreen) && visibleBounds.contains(newClustersOnScreen.getPosition())) {
                ...
                while(true) {
                    ...
                    while(newClustersOnScreen1.hasNext()) {
                        ...
                        if(zoomingIn && marker && TagClusterRenderer.SHOULD_ANIMATE) {
                            onScreen = this.mSphericalMercatorProjection.toPoint(i$1.getPosition());
                            Point point = TagClusterRenderer.findClosestCluster(existingClustersOnScreen, onScreen);
                            if(point != null) {
                                LatLng closest = this.mSphericalMercatorProjection.toLatLng(point);
                                markerModifier.add(true, TagClusterRenderer.this.new CreateMarkerTask(i$1, newMarkers1, closest));
                            } else {
                                markerModifier.add(true, TagClusterRenderer.this.new CreateMarkerTask(i$1, newMarkers1, (LatLng)null));
                            }
                        } else {
                            markerModifier.add(marker, TagClusterRenderer.this.new CreateMarkerTask(i$1, newMarkers1, (LatLng)null));
                        }
                    }
                    ...
                    Iterator i$2;
                    if(TagClusterRenderer.SHOULD_ANIMATE) {
                        newClustersOnScreen2 = new ArrayList();
                        i$2 = this.clusters.iterator();

                        while(i$2.hasNext()) {
                            Cluster marker1 = (Cluster)i$2.next();
                            if(TagClusterRenderer.this.shouldRenderAsCluster(marker1) && visibleBounds.contains(marker1.getPosition())) {
                    ...
                    while(true) {
                        while(i$2.hasNext()) {
                            TagClusterRenderer.MarkerWithPosition marker2 = (TagClusterRenderer.MarkerWithPosition)i$2.next();
                            boolean onScreen1 = visibleBounds.contains(marker2.position);
                            if(!zoomingIn && zoomDelta > -3.0F && onScreen1 && TagClusterRenderer.SHOULD_ANIMATE) {
                                com.google.maps.android.projection.Point point1 = this.mSphericalMercatorProjection.toPoint(marker2.position);
                                Point closest1 = TagClusterRenderer.findClosestCluster(newClustersOnScreen2, point1);
                                if(closest1 != null) {
                        ...
                        markerModifier.waitUntilFree();
                        TagClusterRenderer.this.mMarkers = newMarkers1;
                        TagClusterRenderer.this.mClusters = this.clusters;
                        TagClusterRenderer.this.mZoom = zoom;
                        this.mCallback.run();
                        return;
                    }
                }
    ...
    private class ViewModifier extends Handler {
        ...
        private TagClusterRenderer.RenderTask mNextClusters;
        ...
        public void handleMessage(Message msg) {
            if(msg.what == 1) {
                ...
                if(!this.mViewModificationInProgress) {
                    if(this.mNextClusters != null) {
                        TagClusterRenderer.RenderTask renderTask;
                        synchronized(this) {
                        ...
                        renderTask.setProjection(TagClusterRenderer.this.mMap.getProjection());
                        renderTask.setMapZoom(TagClusterRenderer.this.mMap.getCameraPosition().zoom);
...
//    }
//
//    private static final String TAG =  "TagClusterRenderer";
