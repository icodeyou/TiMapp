...
public class SyncFactory {
    ...
    public static SyncPerformer syncInvitationsReceived(SyncAdapterOption options, final PaginatedSyncResult syncResultMessage) throws IOException, HttpResponseSyncException {
